...
<body>
  ...
  <div class="container">
    ...
    <div class="right-side">
      ...
      <form method="POST" action="{{ route('profile') }}" enctype="multipart/form-data">@csrf
        ...
        <div class="form-group">
          ...
          <input type="text" id="goals" name="goals" placeholder="What is your goal ?">
        </div>
        <div class="form-group">
          <label for="trainer">Trainer</label>
          <input type="text" id="trainer" name="trainer" placeholder="Choose Trainer">
        </div>
